      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <section className="bg-slate-900/80 border border-slate-800/50 rounded-lg p-6">
            ...
            <Link 
              href="/bug-report" 
              className="inline-flex items-center gap-2 bg-blue-900/50 hover:bg-blue-900/70 text-blue-300 px-4 py-2 rounded-lg transition-colors"
            >
          ...
          <section className="bg-slate-900/80 border border-slate-800/50 rounded-lg p-6">
            ...
            <p className="text-slate-400 mb-6">
              Have a question or want to get in touch? Join our Discord community.
            </p>
            <Link 
              href="https://discord.gg/exileorbs" 
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#5865F2] hover:bg-[#4752C4] text-white px-4 py-2 rounded-lg transition-colors"
            >
