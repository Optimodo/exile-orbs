    ...
    <div className="container mx-auto px-2 sm:px-4 py-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          {/* Support Options */}
          <section className="bg-slate-900/80 border border-slate-800/50 rounded-lg p-4">
            <h2 className="text-xl font-bold text-amber-500 font-cinzel tracking-wide mb-4">
              Support Options
            </h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-3">
                <h3 className="text-lg font-bold text-white">Support via Ko-fi</h3>
                <p className="text-slate-400">
                ...
                <Link 
                  ...
                  className="inline-flex items-center gap-2 bg-[#FF5E5B] hover:bg-[#E54D4A] text-white px-3 py-1.5 rounded-lg transition-colors text-sm"
                >
              ...
              {/* GitHub Sponsors */}
              <div className="flex flex-col gap-3">
                <h3 className="text-lg font-bold text-white">Support via GitHub Sponsors</h3>
                <p className="text-slate-400">
                ...
                <Link 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-[#238636] hover:bg-[#2EA043] text-white px-3 py-1.5 rounded-lg transition-colors text-sm"
                >
